...
<body>
      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="<?php echo $first_img; ?>" alt="First slide">
            <div class="carousel-caption d-none d-md-block">
              ...
              <button onclick="window.location.href='login.php'" type="button" class="CA btn btn-lg btn-block btn btn-light"><i class="fa-solid fa-user"></i> Login to Learn More</button>
  ...
  <section id="Sec3">
    ...
    <div class="row d-flex justify-content-around justify-items-center gap-5">
